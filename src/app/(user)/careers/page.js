  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" sx={{ mb: 4, maxWidth: 600, mx: "auto" }}>
        Join our team and help us redefine fashion. We are looking for talented individuals who are passionate about style, innovation, and quality.
      </Typography>
      ...
      <Snackbar open={ openToast} autoHideDuration={3000} onClose={handleCloseToast}>
        <Alert onClose={handleCloseToast}  style={{background: "red",color:'white'}}  severity="success" sx={{ width: '100%' }}>
